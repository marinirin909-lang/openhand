...
export function PlanPreview({
  ...
  return (
    <div className="bg-surface border border-primary rounded-[12px] w-full mb-4 mt-2">
      {/* Header */}
      ...
      {/* Footer */}
      <div className="border-t border-stroke flex h-[54px] items-center justify-start px-4">
        <button
          type="button"
