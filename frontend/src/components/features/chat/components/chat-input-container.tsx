...
export function ChatInputContainer({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-surface box-border content-stretch flex flex-col items-start justify-center p-4 pt-3 relative rounded-[15px] w-full",
        conversationMode === "plan" && "border border-primary",
      )}
