...
export function MicroagentManagementContent() {
  ...
  if (width < 1024) {
    return (
      <div className="w-full h-full flex flex-col gap-6">
        <div className="w-full rounded-lg border border-stroke-alt bg-surface-alt max-h-[494px] min-h-[494px]">
          {providersAreSet && (
        ...
        <div className="w-full rounded-lg border border-stroke-alt bg-surface-alt flex-1 min-h-[494px]">
  ...
  return (
    <div className="w-full h-full flex rounded-lg border border-stroke-alt bg-surface-alt overflow-hidden">
