...
export enum I18nKey {
  ...
  ENTERPRISE$FEATURE_ON_PREMISES = "ENTERPRISE$FEATURE_ON_PREMISES",
  ENTERPRISE$FEATURE_DATA_CONTROL = "ENTERPRISE$FEATURE_DATA_CONTROL",
  ENTERPRISE$FEATURE_COMPLIANCE = "ENTERPRISE$FEATURE_COMPLIANCE",
