...
export enum I18nKey {
  ...
  REASONING_CONTENT$REASONING_CONTENT_LABEL = "REASONING_CONTENT$REASONING_CONTENT_LABEL",
  REASONING_CONTENT$THINKING_BLOCKS = "REASONING_CONTENT$THINKING_BLOCKS",
  REASONING_CONTENT$THINKING_BLOCK_INDEX = "REASONING_CONTENT$THINKING_BLOCK_INDEX",
  REASONING_CONTENT$REDACTED_THINKING_BLOCK_INDEX = "REASONING_CONTENT$REDACTED_THINKING_BLOCK_INDEX",
  REASONING_CONTENT$REDACTED_PLACEHOLDER = "REASONING_CONTENT$REDACTED_PLACEHOLDER",
