...
export enum I18nKey {
  ...
  SETTINGS$SKILLS_SETTINGS = "SETTINGS$SKILLS_SETTINGS",
  SETTINGS$SKILLS_SETTINGS_DESCRIPTION = "SETTINGS$SKILLS_SETTINGS_DESCRIPTION",
  SETTINGS$MARKETPLACE_PATH = "SETTINGS$MARKETPLACE_PATH",
  SETTINGS$MARKETPLACE_PATH_DESCRIPTION = "SETTINGS$MARKETPLACE_PATH_DESCRIPTION",
  SETTINGS$MARKETPLACE_PATH_INVALID = "SETTINGS$MARKETPLACE_PATH_INVALID",
