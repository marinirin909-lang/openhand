...
export enum I18nKey {
  ...
  CREDITS$RELEASE_INFORMATION = "CREDITS$RELEASE_INFORMATION",
  CREDITS$COPYRIGHT = "CREDITS$COPYRIGHT",
  CREDITS$COPYRIGHT_ALLHANDS_2026 = "CREDITS$COPYRIGHT_ALLHANDS_2026",
  CREDITS$OPENHANDS_ENTERPRISE_EDITION = "CREDITS$OPENHANDS_ENTERPRISE_EDITION",
  CREDITS$OPENHANDS_WEB = "CREDITS$OPENHANDS_WEB",
  CREDITS$SOFTWARE_AGENT_SDK = "CREDITS$SOFTWARE_AGENT_SDK",
  CREDITS$MIT_LICENSE_PREFIX = "CREDITS$MIT_LICENSE_PREFIX",
  CREDITS$LICENSE = "CREDITS$LICENSE",
  CREDITS$THIRD_PARTY_PREFIX = "CREDITS$THIRD_PARTY_PREFIX",
}
