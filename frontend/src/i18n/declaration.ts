...
export enum I18nKey {
  ...
  CONVERSATION$DELETE_MULTIPLE_WARNING = "CONVERSATION$DELETE_MULTIPLE_WARNING",
  CONVERSATION$DELETE_SELECTED = "CONVERSATION$DELETE_SELECTED",
  CONVERSATION$SELECT = "CONVERSATION$SELECT",
  CONVERSATION$SELECT_ALL = "CONVERSATION$SELECT_ALL",
